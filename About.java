...
public class About extends JFrame {
    ...
    About(){
        ...
        JLabel name=new JLabel("Developed By: Dr.B.P.Hivale");
        name.setBounds(70,220,550,40);
        name.setFont(new Font("Tahoma",Font.BOLD,30));
        add(name);
        
        JLabel rollno=new JLabel("Number: 1533146");
        rollno.setBounds(70,280,550,40);
        rollno.setFont(new Font("Tahoma",Font.PLAIN,30));
        add(rollno);
        
        JLabel contact=new JLabel("<html>Contact:+91 9898765434<br/>aca.edu.in</html>");
